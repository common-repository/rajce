...
class rajce_widget extends WP_Widget
{
    ...
    {
        parent::__construct('rajce_widget', __('Rajče - seznam galerii', 'rajce_widget_domain'),
            array('description' => __('Rajče - seznam galerii - nejnovější galerie', 'rajce_widget_domain'))
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        $rajce_show_date = apply_filters('rajce_show_date', isset($instance['rajce_show_date']) ? $instance['rajce_show_date'] : false);
        $rajce_remove_server_name = apply_filters('rajce_remove_server_name', isset($instance['rajce_remove_server_name']) ? $instance['rajce_remove_server_name'] : false);
        $rajce_open_in_new_window = apply_filters('rajce_open_in_new_window', isset($instance['rajce_open_in_new_window']) ? $instance['rajce_open_in_new_window'] : false);
    ...
    public function form($instance)
    {
        ...
        $form->addText($this->get_field_id("rajce_title"), $this->get_field_name("rajce_title"), "Titulek widgetu:")->setValue($rajce_title);
        $form->addText($this->get_field_id("rajce_url"), $this->get_field_name("rajce_url"), "URL adresa galerie:")->setValue($rajce_url);
...
add_action('widgets_init', 'registerRajce_widget');

function registerRajce_widget()
{
    return register_widget('rajce_widget');
}
